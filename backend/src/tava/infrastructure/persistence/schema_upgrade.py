...
async def apply_schema_upgrades(conn: AsyncConnection) -> None:
    ...
    statements = [
        ...
        "ALTER TABLE orders ADD COLUMN IF NOT EXISTS claim_code VARCHAR(32)",
        ...
        "CREATE UNIQUE INDEX IF NOT EXISTS uq_orders_claim_code ON orders(claim_code) WHERE claim_code IS NOT NULL",
